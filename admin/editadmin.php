...
<div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-4">
                    <li class="nav-item">
                      <a class="nav-link active" href="../admin/editadmin.php?user=<?=$swa["user"];?>"
                        ><i class="ti-xs ti ti-users me-1"></i> Account</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="../admin/ubahsandiadmin.php?user=<?=$swa["user"];?>"
                    ...
                    <form id="formAccountSettings" action="action.php" method="POST" onsubmit="return confirmEdit(event)" enctype="multipart/form-data">
                      <div class="d-flex align-items-start align-items-sm-center mb-4 gap-4">
                        ...
                        <div class="mt-2">
                          ...
                          <a class="btn btn-label-danger" href="../admin/detailadmin.php?user=<?=$swa["user"];?>">Kembali </a>
